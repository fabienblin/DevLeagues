 ...
 */
class Technology extends \DevLeaguesBundle\Entity\Technology implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'DevLeaguesBundle\\Entity\\Technology' . "\0" . 'id', '' . "\0" . 'DevLeaguesBundle\\Entity\\Technology' . "\0" . 'name', '' . "\0" . 'DevLeaguesBundle\\Entity\\Technology' . "\0" . 'users', '' . "\0" . 'DevLeaguesBundle\\Entity\\Technology' . "\0" . 'challenges'];
        }
