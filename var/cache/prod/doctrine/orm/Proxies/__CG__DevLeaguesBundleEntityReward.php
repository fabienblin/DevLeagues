 ...
 */
class Reward extends \DevLeaguesBundle\Entity\Reward implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'DevLeaguesBundle\\Entity\\Reward' . "\0" . 'id', '' . "\0" . 'DevLeaguesBundle\\Entity\\Reward' . "\0" . 'name', '' . "\0" . 'DevLeaguesBundle\\Entity\\Reward' . "\0" . 'value', '' . "\0" . 'DevLeaguesBundle\\Entity\\Reward' . "\0" . 'challenges'];
        }
