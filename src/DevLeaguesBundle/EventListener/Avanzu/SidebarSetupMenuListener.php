...
class SidebarSetupMenuListener
{
	...
	protected function getMainMenu(Request $request)
	{
		...
		$mainItems = array(
			...
			$news = new MenuItem('main_news', 'News', 'news', $args, 'fa fa-home'),
			$community = new MenuItem('main_community', 'Community', 'community', $args, 'fa fa-home'),
			$challenge = new MenuItem('main_challenges', 'Challenges', 'show_challenges', $args, 'fa fa-home'),
			$leagues = new MenuItem('main_leagues', 'Leagues', 'show_leagues', $args, 'fa fa-home'),
