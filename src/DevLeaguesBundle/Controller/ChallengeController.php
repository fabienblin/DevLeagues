...
class ChallengeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $challenges = $em->getRepository('DevLeaguesBundle:Challenge\Challenge')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('DevLeaguesBundle\Form\ChallengeType', $challenge);
    ...
    {
        $deleteForm = $this->createDeleteForm($challenge);
        $editForm = $this->createForm('DevLeaguesBundle\Form\ChallengeType', $challenge);
