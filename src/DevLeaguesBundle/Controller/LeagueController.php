...
class LeagueController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $leagues = $em->getRepository('DevLeaguesBundle:League\League')->findAll();
    ...
    {
        $league = new League();
        $form = $this->createForm('DevLeaguesBundle\Form\LeagueType', $league);
    ...
    {
        $deleteForm = $this->createDeleteForm($league);
        $editForm = $this->createForm('DevLeaguesBundle\Form\LeagueType', $league);
