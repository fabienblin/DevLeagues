...
use DevLeaguesBundle\Entity\News\News;
...
class NewsController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $news = $em->getRepository('DevLeaguesBundle:News\News')->findAll();
    ...
    {
        $news = new News();
        $form = $this->createForm('DevLeaguesBundle\Form\NewsType', $news);
    ...
    {
        $deleteForm = $this->createDeleteForm($news);
        $editForm = $this->createForm('DevLeaguesBundle\Form\NewsType', $news);
